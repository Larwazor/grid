...
map01 = menu0.add_item('Map1', command=(init_map, 'map1'), selected=True)
...
tile16 = menu1.add_item('32px', command=(resize_tiles, 32), selected=True)
...
diag_off = menu2.add_item('Diagonal off', command=(
